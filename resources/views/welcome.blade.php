					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>E</span>-Book</h1>
									<h2>Sir Francis Bacon.</h2>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-Book</h1>
									<h2>John Fitzgerald Kennedy.</h2>
									<p>“Amar la lectura es trocar horas de hastío por horas de inefable y deliciosa compañía”. </p>
								</div>
								<div class="col-sm-6">
			...
			<div class="row">
						...
						<div class="panel-group category-products" id="accordian">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">{{$categorie->name}}</a></h4>
								</div>
                            </div>
                            @endforeach
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Últimos titulos</h2>
